...
public class SlideY extends Visibility {
	@Override
	...
	private Animator createSlideAnimator(View view, boolean appear) {
		int slideTo = appear ? 0 : -view.getHeight();
		int slideFrom = appear ? -view.getHeight() : 0;
		int alphaTo = appear ? 1 : 0;
		int alphaFrom = appear ? 0 : 1;
		
		AnimatorSet set = new AnimatorSet();
		ObjectAnimator slide = ObjectAnimator.ofFloat(view, View.TRANSLATION_Y, slideFrom, slideTo);
